...
mahaThreshold = sqrt(chi2inv(0.95,1));  % Determined by student, enrico does  chi2inv( 0.95 , 2 ) ; Input = probabilità dei valori che voglio tenere, Output = i valori che tengo
